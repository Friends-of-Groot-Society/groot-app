...
--          USERID NUMBER(10,0),
--          NFT_ID NUMBER(10,0),
--          NFTADDRESS NUMBER(10,0),
--          EMAIL VARCHAR2(255 ),
--          NFTADDRESS_ID NUMBER(10,0),
--          NFTADDRESS_NFTADDRESS_ID NUMBER(10,0)
--     );
...
-- create table nft (id NUMBER not null, amount NUMBER not null, name varchar(255), metadata_id_metadata_id NUMBER, NFTADDRESS_NFTADDRESS_id NUMBER, primary key (id));
-- create table NFTADDRESS (NFTADDRESS_id NUMBER generated by default as identity, address varchar(255), native_token float(53), native float(53), tokens float(24), primary key (NFTADDRESS_id));
...
-- alter table  address add constraint FKsb9kcjn7av3aujmp83pagwiny foreign key (NFTADDRESS_id) references nft_address;
