...
public class UserJDBCService {
    ...
    private final RowMapper<User> userRowMapper = (rs, rowNum) -> new User(rs.getLong("userId"), rs.getString("username"), rs.getString("password"), rs.getString("lastName"), rs.getString("firstName"), rs.getInt("userType"), rs.getString("phone"), rs.getString("email"), rs.getString("cusUrl"), rs.getString("photoPath"), rs.getInt("isActive"));
