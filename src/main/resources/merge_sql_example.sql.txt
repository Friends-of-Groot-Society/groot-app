CREATE TABLE existing_users (
  ...
  CONSTRAINT old_pk_cust PRIMARY KEY (user_id)
);

BEGIN
	INSERT INTO existing_users (user_id, first_name, last_name, address_state, email_address)
...
BEGIN
	INSERT INTO new_users (user_id, first_name, last_name, address_state, email_address)
